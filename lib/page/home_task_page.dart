...
import 'package:flutter_codigo5_fire_task/ui/widgets/item_type_widget.dart';
    ...
    with TickerProviderStateMixin
{
  ...
  showFormTask(BuildContext context, TaskModel? task) {
    showModalBottomSheet(
      ...
      builder: (BuildContext context) {
        return Padding(
          ...
          child: FormTaskWidget(task: task),
        );
      },
    );
  }
            ...
            Container(
              ...
              child: SafeArea(
                child: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    const Text("Bienvenido, Fernando"),
                    Row(
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            return ItemTaskWidget(
                              ...
                              onEdited: (){
                                showFormTask(context,tasks[index]);
                              },
                            );
                          },
                        );
